        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="col-lg-8 col-xlg-9 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material" action="traitement/traitement-ajout.php" method="post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <textarea rows="5" class="form-control p-0 border-0" name="contenu" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
